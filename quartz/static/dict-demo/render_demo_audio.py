...
CLIPS: list[tuple[str, str]] = [
    ...
    ("zao-meanings.mp3", "造的本義是到達。製造、建造的意思，是借音來的。再引申為製作、捏造、造成。"),
    ("zao-evolution.mp3", "早期金文的造，常見從彳或辵，加告。現代製造的意思是借音來的，跟走路的偏旁沒有邏輯關係。"),
    # 造 examples
    ("zao-ex-0.mp3", "這座橋是去年造的。"),
    ("zao-ex-1.mp3", "這家工廠製造電動車。"),
    ("zao-ex-2.mp3", "他喜歡自己造句，練習中文。"),
    ("zao-ex-3.mp3", "人造的光，比不上太陽。"),
    ("zao-ex-4.mp3", "這場大雨造成了很多問題。"),
    ("zao-ex-5.mp3", "別捏造事實。"),
    # 鬧 sections
    ("nao-story.mp3", "想像一個夜市：到處都是人，大家都在喊。鬥，吵架的聲音，包住一個市場。這就是鬧。"),
    ("nao-origin.mp3", "鬧，外面是鬥，吵架的鬥，裡面是市。吵架的聲音包住一個市場，這就是鬧。"),
    ...
    # 射 sections
    ("she-origin.mp3", "射的身，不是身體。古文字裡，它本來是一張拉開的弓，箭在弦上。後來字形慢慢走樣，寫成了身。寸是一隻手。"),
    ("she-story.mp3", "一個身體，側過來，挽起弓，一寸一寸把弦拉滿。咻，射出去。"),
    ("she-meanings.mp3", "射，本義是射箭。引申為噴射、放射。再引申為影射。"),
    ("she-evolution.mp3", "甲骨文的射，畫的是弓和箭。金文加上手。弓的形狀後來慢慢走樣，變成了身。"),
    # 射 examples
    ("she-ex-0.mp3", "他射箭射得很準。"),
    ("she-ex-1.mp3", "太陽光射進房間裡。"),
    ("she-ex-2.mp3", "噴泉把水射到空中。"),
    ("she-ex-3.mp3", "他射門得分了！"),
    ("she-ex-4.mp3", "這部電影影射了很多社會問題。"),
    # 熱鬧 additions
